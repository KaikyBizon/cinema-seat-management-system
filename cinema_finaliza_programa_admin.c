...
int main() {
  ...
  while (acabar != 1) {
    ...
    if (erro == 0) {
      ...
      if (pwd != pwds[usr_idx]) {
        ...
        while (final == 0) {
          ...
          do {
            ...
            if (opt < 1 || opt > opt_lim) {
              printf("Opcao fora dos limites.\n");
            }
          } while (flag == 0 || opt < 1 || opt > opt_lim);
          ...
          switch (opt) {
            ...
            case 6:
              ...
              do {
                ...
                if (acabar < 1 || acabar > 2) {
                  printf("Opcao fora dos limites.\n");
                }
              } while (flag == 0 || acabar < 1 || acabar > 2);
      ...
      if (usrs[usr_idx] != admin && usr_seats[usr_idx] == 0) {
        usrs[usr_idx] = 0;
      }
    }
  }
